...
<body class="inicial"  id="pawegrap">
    <div  id="content">  
       ...
       <table style="width: calc(100% - 120px);"> 
        ...
        <tr> 
    <td><button type="submit" value="INICIAR SESION"><img src="css/IMG/usuario.png"  height="30px" width="30px"/> INICIAR SESION</button></td>
    <td><button type="submit" value="EXPLORAR"><img src="css/IMG/buscar.png"  height="30px" width="30px"/>EXPLORAR</button></td>
    <td><button type="submit" value="INICIAR SESION"><img src="css/IMG/empresa.png"  height="30px" width="30px"/> INICIAR SESION</button></td>
        </tr> 
         <tr>    
