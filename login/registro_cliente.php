...
<body class="inicial"  id="pawegrap">
    ...
    <form action="validar.php" method="post" id="cuadro" class="cuadro">
    <h1>REGISTRO USUARIO</h1>
    <p>Nombre del usuario:<input type="text" placeholder="Ingrese nombre" name="usuario" id="usuario"></p>    
    <p>Contraseña:<input type="password" placeholder="Contraseña" name="contraseña1" id="contraseña"></p>
    ...
    <button type="button" id="registro" class="registro_cliente" onclick="registro_es()">REGISTRAR</button>
</form>
    </article>
</div>
