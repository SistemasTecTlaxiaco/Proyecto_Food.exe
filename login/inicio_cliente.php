...
<body class="inicial" id="pawegrap">
    ...
    <p>Telefono:<input type="tel" placeholder="Ingrese teléfono" name="usuario"></p>    
    <p>Contraseña:<input type="password" placeholder="Ingrese contraseña" name="contraseña"></p>
    <br><p>Aun no tienes una cuenta <a href="">Registrarse </a> </p>
    <input type="submit" value="INGRESAR" href="home.php">
</form>
    </article>
</div>
</body>
