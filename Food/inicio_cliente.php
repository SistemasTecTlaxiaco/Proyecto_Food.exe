...
<body class="inicial" id="pawegrap">
    ...
    <!--Usa el formulario en validarCliente.php para comprobar existecia-->
    <form action="validarCliente.php" method="post" id="cuadro" class="cuadro">
    ...
    <br><p>Aun no tienes una cuenta <a href="registro_cliente.php">Registrarse </a> </p>
